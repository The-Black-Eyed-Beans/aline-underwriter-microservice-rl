    ...
    stages {
            ...
            stage("Push") {
                ...
                steps {
                    ...
                    dir('underwriter-microservice/target'){
                        sh 'curl -X "PUT" -u "$JFROG_USER:$JFROG_PW" --upload-file "underwriter-microservice-0.1.0.jar" "http://$JFROG_HOST/artifactory/microservices-jar-local/underwriter-microservice-0.1.0.jar"'
                    }
